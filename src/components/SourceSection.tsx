    ...
    <section id="source" className="relative overflow-hidden py-16 sm:py-24 md:py-28">
      ...
      <div className="site-shell relative z-10">
        ...
        >
          ...
          <h2 className="mb-6 sm:mb-8 font-display text-3xl sm:text-4xl md:text-6xl xl:text-7xl font-bold text-foreground leading-tight">
            From the Heart of <span className="text-gold-gradient italic">Earth</span>
          </h2>
          <p className="mx-auto mb-10 sm:mb-12 max-w-4xl font-elegant text-base sm:text-lg xl:text-xl text-muted-foreground leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3 md:gap-8 xl:gap-10">
